...
from models.vae.no_max_pool import LargeFilterSizesVAE, SmallFilterSizesVAE, DecreasingFilterSizesVAE
from models.vae.with_max_pool import (LargeFilterSizesMaxPoolVAE, SmallFilterSizesMaxPoolVAE,
                                      DecreasingFilterSizesMaxPoolVAE)
