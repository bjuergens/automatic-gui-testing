...
class LargeFilterSizesMaxPoolVAE(BaseVAE):
    ...
    def __init__(self, model_parameters: dict):
        ...
        conv_1 = nn.Conv2d(in_channels=self.input_channels, out_channels=self.hidden_dimensions[0], kernel_size=11, stride=1, padding=5)
        conv_2 = nn.Conv2d(in_channels=self.hidden_dimensions[0], out_channels=self.hidden_dimensions[1], kernel_size=11, stride=1, padding=5)
        conv_3 = nn.Conv2d(in_channels=self.hidden_dimensions[1], out_channels=self.hidden_dimensions[2], kernel_size=11, stride=1, padding=5)
        conv_4 = nn.Conv2d(in_channels=self.hidden_dimensions[2], out_channels=self.hidden_dimensions[3], kernel_size=11, stride=1, padding=5)
        conv_5 = nn.Conv2d(in_channels=self.hidden_dimensions[3], out_channels=self.hidden_dimensions[4], kernel_size=11, stride=1, padding=5)
        conv_6 = nn.Conv2d(in_channels=self.hidden_dimensions[4], out_channels=self.hidden_dimensions[5], kernel_size=11, stride=1, padding=5)
        ...
        # Bottleneck 6x6 when using MaxPool(2, 2) and at the last MaxPool filter size 3
        ...
        transposed_conv_1 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[5], out_channels=self.hidden_dimensions[4], kernel_size=11, stride=2, padding=4, output_padding=1)
        transposed_conv_2 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[4], out_channels=self.hidden_dimensions[3], kernel_size=11, stride=2, padding=5, output_padding=1)
        transposed_conv_3 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[3], out_channels=self.hidden_dimensions[2], kernel_size=11, stride=2, padding=5, output_padding=1)
        transposed_conv_4 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[2], out_channels=self.hidden_dimensions[1], kernel_size=11, stride=2, padding=5, output_padding=1)
        transposed_conv_5 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[1], out_channels=self.hidden_dimensions[0], kernel_size=11, stride=2, padding=5, output_padding=1)
        transposed_conv_6 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[0], out_channels=self.input_channels, kernel_size=11, stride=2, padding=5, output_padding=1)
...
def main():
    ...
    model = LargeFilterSizesMaxPoolVAE({
        "input_channels": 3,
        "latent_size": 32,
