...
class DecreasingFilterSizesMaxPoolVAE(BaseVAE):
    ...
    def __init__(self, model_parameters: dict):
        ...
        conv_2 = nn.Conv2d(in_channels=self.hidden_dimensions[0], out_channels=self.hidden_dimensions[1], kernel_size=9, stride=1, padding=4)
        conv_3 = nn.Conv2d(in_channels=self.hidden_dimensions[1], out_channels=self.hidden_dimensions[2], kernel_size=7, stride=1, padding=3)
        conv_4 = nn.Conv2d(in_channels=self.hidden_dimensions[2], out_channels=self.hidden_dimensions[3], kernel_size=5, stride=1, padding=2)
        ...
        transposed_conv_3 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[3], out_channels=self.hidden_dimensions[2], kernel_size=5, stride=2, padding=2, output_padding=1)
        transposed_conv_4 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[2], out_channels=self.hidden_dimensions[1], kernel_size=7, stride=2, padding=3, output_padding=1)
        transposed_conv_5 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[1], out_channels=self.hidden_dimensions[0], kernel_size=9, stride=2, padding=4, output_padding=1)
...
def main():
    ...
    model = DecreasingFilterSizesMaxPoolVAE({
        "input_channels": 3,
        "latent_size": 32,
