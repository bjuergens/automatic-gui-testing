...
class HalfInputSmallFilterSizesSmallBottleneckVAE2(BaseVAE):
    ...
    def __init__(self, model_parameters: dict):
        ...
        conv_7 = nn.Conv2d(in_channels=self.hidden_dimensions[5], out_channels=self.hidden_dimensions[6], kernel_size=3, stride=1, padding=0)
        ...
        transposed_conv_0 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[6], out_channels=self.hidden_dimensions[5], kernel_size=3, stride=1, padding=0, output_padding=0)
        transposed_conv_1 = nn.ConvTranspose2d(in_channels=self.hidden_dimensions[5], out_channels=self.hidden_dimensions[4], kernel_size=3, stride=2, padding=1, output_padding=0)
...
def main():
    ...
    model = HalfInputSmallFilterSizesSmallBottleneckVAE2({
        "input_channels": 3,
        "latent_size": 32,
